...
use crate::gpu::MODUL0_VK_SWAPCHAIN::proc::processor::physical_device::pick_physical_device_queue_family_extrl;
...
impl PhysicalDeviceSelectAuto for (vk::PhysicalDevice, u32) {
    fn auto_assemble(
        ...
        pick_physical_device_queue_family_extrl(
            instance_extrl,
        ...
        .ok_or_else(|| {
            "No suitable physical device found (need GRAPHICS+COMPUTE+present; discrete preferred)"
                .to_string()
        })
    }
}
