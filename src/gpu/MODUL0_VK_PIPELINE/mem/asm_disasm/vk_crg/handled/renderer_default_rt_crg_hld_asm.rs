...
impl RendererDefaultRtCrgHandled for RendererDefaultRtCrg {
    fn handled_assemble(bfr: &mut RendererBfr) -> ModulResult<RendererDefaultRtCrg> {
        Ok(Self {
            ...
            shaders_mesh_solid_rt_pkg: bfr.shaders_mesh_solid_rt_pkg.take(),
            pipeline_mesh_solid_rt_pkg: bfr.pipeline_mesh_solid_rt_pkg.take(),
            ...
            pipeline_mesh_soa_comp_rt_pkg: bfr.pipeline_mesh_soa_comp_rt_pkg.take(),
            pipeline_soa_heat_comp_rt_pkg: bfr.pipeline_soa_heat_comp_rt_pkg.take(),
            descriptor_set_layout_default_rt_pkg: bfr.descriptor_set_layout_default_rt_pkg.take(),
            descriptor_pool_default_rt_pkg: bfr.descriptor_pool_default_rt_pkg.take(),
            descriptor_sets_default_rt_pkg: bfr.descriptor_sets_default_rt_pkg.take(),
