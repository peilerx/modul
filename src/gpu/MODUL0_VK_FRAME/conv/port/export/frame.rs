...
#[must_use]
pub fn export_asmed_frame_render(frame_default_rt_crg: &FrameDefaultRtCrg) -> FrameRenderDefaultRtPkg {
...
#[must_use]
pub fn export_frame_fif_count(frame_fif_prt: FrameFifPrt) -> u32 {
    match frame_fif_prt {
